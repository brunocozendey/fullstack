...
var _foreach = _interopRequireDefault(require("./utils/foreach"));

var valid = _interopRequireWildcard(require("./utils/valid"));
...
class Query {
  ...
  select() {
    (0, _foreach.default)(arguments, field => {
      ...
      if (typeof field === 'string') {
        ...
        (0, _foreach.default)(field, f => {
          this.fields.push(this.escapeField(f));
        });
      } else if (typeof field === 'object') {
        (0, _foreach.default)(field, (f, as) => {
  ...
  _whereString() {
    ...
    if (this.whereFields.length) {
      (0, _foreach.default)(this.whereFields, ([type, where], i) => {
        if (i === 0) {
          str += where;
        } else {
          str += ` ${type} ${where}`;
  ...
  insert(obj) {
    ...
    (0, _foreach.default)(arr, item => {
      (0, _foreach.default)(item, (value, key) => {
        if (this.fields.indexOf(key) === -1) {
          this.fields.push(key);
        }
      });
    });
    (0, _foreach.default)(arr, (item, index) => {
      const row = [];
      (0, _foreach.default)(this.fields, field => {
